...
Rules are simple statements to guide behavior.  Some example rules are:
...
Because of their brevity, rules can't be fully accurate in all situations.
...
## Moral Guidelines are not Simple
