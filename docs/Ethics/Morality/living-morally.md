...
This is an interesting theory because: it provides an independent test for moral teaching.  It gives us a straightforward test to apply to moral claims.  It renders a verdict on any possible action.  The three subtheses it rests on are all plausable.
