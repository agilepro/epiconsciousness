...
**If morality is just about outcomes, then whoever wins decides what’s right.** - NO! This is a complete misunderstanding. If certain moral values lead to survival, you don't have the ability to just decide them. Those who follow _good_"_ morals are not able to choose what behaviors are moral and what behaviors are not. Let's say they were to _choose_ that murder should be legal. If they really believed that murder was just and acceptable behavior, they would die out very quickly. That is an extreme example to demonstrate that no amount of _choice_ allows the winners to choose what allowed them to win.  A foot race is won merely by being the first to cross the line. Whatever you define "good running" as, is whatever kind of running gets you across the finish line first. A runner can't merely _decide_ that running backward is "good running". When running backward is _good_ is decided by whether it gets them across the line first.

**If morality is only what benefits life, then there’s no real ought, just preference, so on what basis could you ever call anything truly wrong?** - Yes, that is what most people ask. It seems incredible that good could simply be survival. All your life you have been told to be good, and good was this magic quality that you strive for, but the connection to survival is tenuous. It is not obvious at all.  The idea is that "ought" should have something qualitatively better about it. Hume said you can't get "from is to ought" but that is true when the game you are playing is not known. The game however is survival, that gives a definition connection: there ARE moves in the survival game that are unquestionably better than others. A given that we all want to win the survival game, those moves are absolutely good.  Again, this is not a preference. It is not that I prefer to do certain actions, or even that I prefer to live. This is the dynamic of the universe and it is from there that these moral actions are discovered. The evolution of animals is not a choice of the animals to get more complex (and more successful) but that inherent in evolution. My position is that animal group behaviors evolve in a very similar fashion: bad moral behavior simply dies out like bad animal designs. It is "truly wrong" for example to wipe out all the life on earth. Some will argue that it "might" be better without life, but that is an arbitrary claim. My claim that life is in general good is not arbitrary in any way: it is in fact the tendency of the universe.

**Why should survival itself be the highest moral good?** - It seems that people simply prefer the idea that some intelligence _says_ what is good and bad.  That satisfies the "god is like a father" feeling that we all have.  Thinking that morality simply falls out of the natural world is something that nobody really wants to believe. 
